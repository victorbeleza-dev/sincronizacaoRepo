...
*/
package com.br.sincronizacaoreceita.model;

import com.br.sincronizacaoreceita.service.ReceitaService;
import com.br.sincronizacaoreceita.service.impl.ReceitaServiceImpl;
...
public class SincronizacaoReceita {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ReceitaServiceImpl receitaService = new ReceitaServiceImpl();
        System.out.println(receitaService.atualizarConta("0000","000000", 1.2, "A"));
